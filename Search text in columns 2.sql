USE FDM_DB
DECLARE @SearchStr nvarchar(100) = '110u'
...
SELECT * FROM TrifocusMapping
SELECT * FROM DimTrifocusTree WHERE pkDimTrifocusTree LIKE '%110u%'
SELECT * FROM DimTrifocusTree WHERE pkDimTrifocusTreeParent LIKE '%110u%'
SELECT * FROM TrifocusMapping WHERE FDMTrifocusCode LIKE '%110u%'